...
function Navbar({
  ...
  const pcNavContent = (
    <Row className="justify-between items-center">
      <Link href="/">
        <Image className='gg' src="https://pbs.twimg.com/profile_images/1600956334635098141/ZSzYTrHf_400x400.jpg" />
      </Link>
  ...
  return (
    <nav className={twMerge('select-none text-white px-12 py-4 mobile:p-0 transition-all no', className)} style={style}>
  ...
  return (
    <>
      ...
      <Drawer placement="from-bottom" open={isDropdownOpen} onClose={() => setIsDropdownOpen(false)}>
        {({ close }) => (
          <Card
            className="flex flex-col max-h-[60vh] mobile:max-h-full mobile:rounded-tl-3xl mobile:rounded-tr-3xl  mobile:w-full border-1.5 border-[rgba(171,196,255,0.2)] overflow-hidden "
            size="lg"
          >
