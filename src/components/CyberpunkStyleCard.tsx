  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundImage: 'linear-gradient(var(--gradient-rotate, 246deg), #FF7600 7.97%, #FF7600 49.17%, #FF7600 92.1%)',
        border: '3px solid #141041'
      }}
    >
      <Card
        {...restProps}
        size={size}
        className={twMerge('overflow-hidden', restProps.className)}
        style={{
          height: '100%',
          width: '100%'
        }}
