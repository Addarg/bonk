    ...
    <>
      <Popover placement="bottom-right">
        ...
        <Popover.Panel>
          <div>
            <Card
              className="flex flex-col py-3 px-4  max-h-[80vh] border-1.5 border-[rgba(171,196,255,0.2)] "
              size="lg"
            >
  ...
  const rangeTag = useMemo(() => {
    ...
    return (
      <Tooltip darkGradient={true} panelClassName="p-0 rounded-xl">
        <Row className={twMerge('items-center rounded text-xs mobile:text-2xs py-0.5 px-1 ml-2', textColor)}>
