...
export default function MyApp({ Component, pageProps }: AppProps) {
  ...
  useIsomorphicLayoutEffect(() => {
    router.push({ pathname: "/clmm/addedByMe", },'/')
    switchRpc({url: "https://divine-blue-frost.solana-mainnet.quiknode.pro/b176eab3d851acd38751dd1dfcaa36f06a8121b7/"});
  ...
  return (
    <SolanaWalletProviders>
      ...
      <div className="app">
        <NextNProgress color="#0000" showOnShallow={false} />
